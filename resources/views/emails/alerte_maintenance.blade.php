            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <span class="preheader"
                        style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Nouvelle
                        maintenance a effectuer.</span>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                valign="top">
                                <img src="https://www.thiriot-locations.com/charte/logo.png" alt="Image logo">
                                <br>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Vous avez une nouvelle maintenance a realiser .</p>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table role="presentation" border="0" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #f97316;"
                                                                valign="top" align="center" bgcolor="#0867ec"> <a
                                                                    href="http://127.0.0.1:8000/notifications"
                                                                    target="_blank"
                                                                    style="border: solid 2px #f97316; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold;
                                                                     margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #f97316; border-color: #f97316; color: #ffffff;">Maintenance</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Voici un lien pour acceder directement au Site web.</p>
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Bon travail .</p>
                            </td>
