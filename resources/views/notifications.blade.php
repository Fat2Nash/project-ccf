                                            ...
                                            @foreach ($clients as $client)
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        ...
                                                        <p class="text-gray-500 ">{{ $client->ville }},
                                                            {{ $client->code_postal }}, {{ $client->pays }}</p>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    ...
                                                    <a title="Supprimer l'engin" class="cursor-pointer"
                                                        href="/supprimer_client/{{ $client->id_client }}"><i
                    ...
                    <div x-data="{ isOpen: false }">
                        ...
                        <div x-show="isOpen"
                            ...
                            <form action="/nouveau_client" method="post">
                                ...
                                <label>Téléphone : </label><input name="telephone" type="tel"
                                    placeholder="+33 1 23 45 67 89">
                                <label>Note : </label>
                                <textarea name="notes" type="text" placeholder="Eventuelles notes et/ou information supplémentaires"></textarea>
                                <button type="submit"
                                    class="flex justify-center w-1/2 px-5 py-2 text-sm text-white transition-colors duration-200 bg-orange-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-orange-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
