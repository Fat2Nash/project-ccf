...
<div class="fixed top-0 left-0 z-50 w-64 h-full p-4 transition-transform bg-white shadow-inner sidebar-menu">
    ...
    <ul class="mt-4" id="sidebar-menu">
        ...
        <li class="mb-1 group">
            <a href="/engins-disponibles" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="liste-engins">
        ...
        <li class="mb-1 group">
            <a href="/maintenances" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="maintenance">
                <i class='mr-3 text-lg bx bx-wrench'></i>
                <span class="text-sm">Maintenance</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="/livraisons" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="livraisons">
        ...
        <li class="mb-1 group">
            <a href="/location-fiche" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="fiches-locations">
        ...
        <li class="mb-1 group">
            <a href="/parametres" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="parametres">
