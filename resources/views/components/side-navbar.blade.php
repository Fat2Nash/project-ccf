    ...
    <div class="fixed top-0 left-0 z-50 w-64 h-full p-4 overflow-y-scroll transition-transform bg-white sidebar-menu">
        ...
        <li class="mb-1 group">
            <a href="/notifications" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="notifications">
