<!-- sidenav -->
<div class="fixed top-0 left-0 z-50 w-64 h-full p-4 overflow-y-scroll transition-transform bg-white shadow-inner sidebar-menu">
    ...
    <ul class="mt-4" id="sidebar-menu">
        ...
        <li class="mb-1 group">
            <a href="/" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="accueil">
                <i class="mr-3 text-lg bx bx-home"></i>
                <span class="text-sm">Accueil</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="#" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="liste-engins">
        ...
        <li class="mb-1 group">
            <a href="/MapsEngins" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="carte">
        ...
        <li class="mb-1 group">
            <a href="#" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="maintenance">
                <i class='mr-3 text-lg bx bx-wrench'></i>
                <span class="text-sm">Maintenance</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="#" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="livraisons">
        ...
        <li class="mb-1 group">
            <a href="/clients" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="fiches-clients">
                <i class='mr-3 text-lg bx bx-face'></i>
                <span class="text-sm">Fiches clients</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="/engins" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="fiches-engins">
                <i class='mr-3 text-lg bx bx-hard-hat'></i>
                <span class="text-sm">Fiches engins</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="#" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="fiches-locations">
                <i class='mr-3 text-lg bx bx-spreadsheet'></i>
                <span class="text-sm">Fiches locations</span>
            </a>
        </li>
        <li class="mb-1 group">
            <a href="/HistoriqueLocations" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="historique-locations">
                <i class='mr-3 text-lg bx bx-spreadsheet'></i>
        ...
        <li class="mb-1 group">
            <a href="#" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="notifications">
        ...
        <li class="mb-1 group">
            <a href="#" class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md hover:bg-orange-600 hover:text-gray-100" data-link="parametres">
        ...
        <li class="mb-1 group">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <a class="flex items-center px-4 py-2 font-semibold text-gray-900 rounded-md cursor-pointer hover:bg-red-600 hover:text-gray-100" data-link="logout" onclick="event.preventDefault(); this.closest('form').submit();">
